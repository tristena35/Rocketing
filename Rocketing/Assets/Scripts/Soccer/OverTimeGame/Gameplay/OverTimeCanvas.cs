...
public class OverTimeCanvas : MonoBehaviour
{
    // Cached References
    ...
    void Update()
    {
        ...
        if( buildIndex == 1 || buildIndex == 2 || buildIndex == 6 ) // End Screen Delete Object or Main menu or Car Select
        {
            Destroy(gameObject);
        }

        if ( buildIndex == 5 && doOnce ) // In Win Screen
        {
            isLastScene = true;
