...
public class PreserveCanvas : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if( buildIndex == 1 || buildIndex == 2 || buildIndex == 6 || buildIndex == 7 || buildIndex == 12 || buildIndex == 13 ) // End Screen Delete Object or Main menu or Car Select or OT
        {
            Destroy(gameObject);
        }

        if ( ( buildIndex == 5 && doOnce ) || ( buildIndex == 11 && doOnce ) ) // In Win Screen
        {
            isLastScene = true;
